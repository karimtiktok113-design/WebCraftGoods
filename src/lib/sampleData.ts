...
export const INITIAL_FEATURES: Feature[] = [
  {
    ...
    description: 'Get started without complicated setup. Our tools are designed with intuitive interfaces that make planning, tracking, and organizing feel effortless.',
    order: 1,
  },
  {
    id: 'feat-modern-design',
    icon: 'Palette',
    heading: 'Beautiful Modern Design',
    description: 'Enjoy clean, colorful, and thoughtfully crafted interfaces that combine professional functionality with a polished visual experience.',
    order: 2,
  },
  {
    id: 'feat-responsive-screens',
    icon: 'Smartphone',
    heading: 'Responsive on Every Screen',
    description: 'Designed to adapt beautifully across desktops, laptops, tablets, and mobile devices, so your tools remain accessible wherever you work.',
    order: 3,
  },
  {
    id: 'feat-works-offline',
    icon: 'Globe',
    heading: 'Works Offline',
    description: 'Many of our HTML-based tools can work directly in your browser without requiring a constant internet connection.',
    order: 4,
  },
  {
    id: 'feat-local-saving',
    icon: 'HardDrive',
    heading: 'Local Data Saving',
    description: 'Supported tools can save your information locally in your browser, helping you continue where you left off without creating an online account.',
    order: 5,
  },
  {
    id: 'feat-backup-restore',
    icon: 'RefreshCw',
    heading: 'Backup & Restore',
    description: 'Keep your important information protected with convenient backup and restore options available in many of our interactive tools.',
    order: 6,
  },
  {
    id: 'feat-smart-dashboards',
    icon: 'BarChart3',
    heading: 'Smart Dashboards & Insights',
    description: 'Turn your information into something useful with organized dashboards, summaries, charts, graphs, progress indicators, and insights where supported.',
    order: 7,
  },
  {
    id: 'feat-export-options',
    icon: 'Share2',
    heading: 'Practical Export Options',
    description: 'Export, print, or save your information using PDF, CSV, print, and other supported formats depending on the product.',
    order: 8,
  },
];
